...
try {
  switch (command) {
    ...
    default: throw new Error('Usage: node .github/scripts/release.ts canary-version|prepare|check|publish|verify|github [--directory PATH] [--benchmark-dir PATH] [--source-sha SHA]');
  }
} catch (error) {
